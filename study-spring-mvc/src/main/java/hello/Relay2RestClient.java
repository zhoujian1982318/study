...
//            Registry<ConnectionSocketFactory> socketFactoryRegistry = RegistryBuilder.<ConnectionSocketFactory> create().register("http", PlainConnectionSocketFactory.getSocketFactory()).build();
  ...
  //          					   .setCharset(Charset.forName("UTF-8"))
                                   ...
                                   .addParameter("wlanName","测试555")
                                   .addParameter("SSID","banner_insert1")
                                   .addParameter("adminStatus","2")
                                   .addParameter("wlanType","0")
                                   .addParameter("portalUrl","https://www.mycompany.com/portal.php")
//                                   .addParameter("idMd","4")
//                                   .addParameter("l2SecurityType","12")
//                                   .addParameter("presharedKey","12345678")
                               //    .addParameter("mode","1")
                               //    .addParameter("apMac","B4:82:C5:00:0C:22")
                               //    .addParameter("idWlan","10")
                               //    .addParameter("adminStatus","1")
                               //    .addParameter("bnFileName","banner-insertion.zip")
                                   .build();
            
//            HttpUriRequest request = RequestBuilder.post(WS_URL.concat("Ws"+UPDATE_WLAN)).addParameter("accountName", acctName)
//                    .addParameter("reqId", reqId)
//                    .addParameter("actor", actor)
//                    .addParameter("accessKey", accessKey)
//                    .addParameter("action", UPDATE_WLAN)
//                    .addParameter("ts", String.valueOf(ts))
//                    .addParameter("version",version)
//                    .addParameter("authCode",authCode)
//                    .addParameter("idWlan","1")
//                    .addParameter("wlanName","testwlan6")
//                    .addParameter("SSID","test7")
//                    .addParameter("portalUrl","https://www.mycompany.com/portal2.php")
//                    .addParameter("idBanner","3")
//                    .build();
...
//          request.setHeader("Content-Type", "application/json; charset=UTF-8");
    ...
    private static final String GET_WLAN = "GetWlan";
    private static final String UPDATE_WLAN = "UpdateWlan";
    private static final String WS_URL = "https://www.qc.cn/exnms/";
    private static final String GET_HTTP_CAP = "GetHttpCapFileList";
    private static final String GET_RSSI_FILE = "GetRSSIFileList";
