...
public class Main {
	...
	public static void main(String[] args) {
		...
		String[] uas = new String[] {
				...
				"Mozilla/4.0 (compatible; MSIE 5.0b1; Mac_PowerPC)", "Mozilla/4.0 (PDA; Windows CE/1.0.1) NetFront/3.0",
				...
				"Mozilla/5.0 (Nintendo 3DS; U; ; en) Version/1.7498.EU", "Opera/9.30 (Nintendo Wii; U; ; 2047-7; en)",
				...
				"Mozilla/5.0 (PLAYSTATION 3; 1.00)", "Mozilla/4.0 (PSP (PlayStation Portable); 2.00)",
		...
		//	System.out.println(agent.getOperatingSystem().getDeviceType() + "\t\t" + agent.getOperatingSystem().getName());
		//}
		UserAgent agent = UserAgent.parseUserAgentString("Dalvik/v3.3.105 Compatible (TVM xx; YunOS 3.0; Linux; U; Android 4.4.2 Compatible; NewMan-K5 Build/KOT49H)");
		System.out.println(agent.getOperatingSystem().getDeviceType() + "\t\t" + agent.getOperatingSystem().getName()+"\t\t"+agent.getOperatingSystem().getManufacturer());
